...
int step = 20;          // шаг изменения скорости
...
//#define DEBUG           // Вывод значения с датчиков после преобразования

#define SPEED_MIN (1000)         // Минимальная скорость импеллера
#define SPEED_MAX (1500)         // Максимальная скорость импеллера
...
ESC myESC (IMP, SPEED_MIN, SPEED_MAX, 500);                 // ESC_Name (ESC PIN, Minimum Value, Maximum Value, Default Speed, Arm Value)
